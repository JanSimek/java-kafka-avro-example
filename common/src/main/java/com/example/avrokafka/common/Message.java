 ...
 */
package com.example.avrokafka.common;
...
public class Message extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6679214290453371874L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Message\",\"namespace\":\"com.example.avrokafka.common\",\"doc\":\"Example Message\",\"fields\":[{\"name\":\"user\",\"type\":\"string\"},{\"name\":\"message\",\"type\":\"string\"}]}");
   ...
   */
  public Message(java.lang.CharSequence user, java.lang.CharSequence message) {
    this.user = user;
   ...
   */
  public static com.example.avrokafka.common.Message.Builder newBuilder() {
    return new com.example.avrokafka.common.Message.Builder();
  }
   ...
   * @return A new Message RecordBuilder
   */
  public static com.example.avrokafka.common.Message.Builder newBuilder(com.example.avrokafka.common.Message.Builder other) {
    return new com.example.avrokafka.common.Message.Builder(other);
  }
   ...
   * @return A new Message RecordBuilder
   */
  public static com.example.avrokafka.common.Message.Builder newBuilder(com.example.avrokafka.common.Message other) {
    return new com.example.avrokafka.common.Message.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Message>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.avrokafka.common.Message.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.avrokafka.common.Message other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.user)) {
        this.user = data().deepCopy(fields()[0].schema(), other.user);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avrokafka.common.Message.Builder setUser(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avrokafka.common.Message.Builder clearUser() {
      user = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avrokafka.common.Message.Builder setMessage(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avrokafka.common.Message.Builder clearMessage() {
      message = null;
